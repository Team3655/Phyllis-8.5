...
public class AutoDriveOnEncoders extends Command {
    public AutoDriveOnEncoders() {
    ...
    protected boolean isFinished() {
        ...
        if (driveLeft1.getSelectedSensorPosition(0) <= 1440 && driveRight1.getSelectedSensorPosition(0) <= 1440){
            return false;
        } else{
            return true;
        }
